...
public final class CommandRegistrationManager {
  ...
  private static String permissionsMessage =
      LocaleLoader.getString("mcMMO.NoPermission");
  ...
  private static void registerSkillCommands() {
    for (PrimarySkillType skill : PrimarySkillType.values()) {
      ...
      command.setDescription(
          LocaleLoader.getString("Commands.Description.Skill",
                                 StringUtils.getCapitalized(localizedName)));
      command.setPermission("mcmmo.commands." + commandName);
      command.setPermissionMessage(permissionsMessage);
      command.setUsage(
          LocaleLoader.getString("Commands.Usage.0", localizedName));
      command.setUsage(
          command.getUsage() + "\n" +
          LocaleLoader.getString(
              "Commands.Usage.2", localizedName, "?",
  ...
  private static void registerAddlevelsCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.addlevels"));
    command.setPermission(
        "mcmmo.commands.addlevels;mcmmo.commands.addlevels.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.3", "addlevels",
  ...
  private static void registerAddxpCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.addxp"));
    command.setPermission("mcmmo.commands.addxp;mcmmo.commands.addxp.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.3", "addxp",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]",
        "<" + LocaleLoader.getString("Commands.Usage.Skill") + ">",
  ...
  private static void registerMcgodCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcgod"));
    command.setPermission("mcmmo.commands.mcgod;mcmmo.commands.mcgod.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mcgod",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]"));
  ...
  private static void registerMmoInfoCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmoinfo"));
    command.setPermission("mcmmo.commands.mmoinfo");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mmoinfo",
  ...
  private static void registerMmoDebugCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmodebug"));
  ...
  private static void registerMcChatSpyCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcchatspy"));
    command.setPermission(
        "mcmmo.commands.mcchatspy;mcmmo.commands.mcchatspy.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mcchatspy",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]"));
  ...
  private static void registerMcrefreshCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcrefresh"));
    command.setPermission(
        "mcmmo.commands.mcrefresh;mcmmo.commands.mcrefresh.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mcrefresh",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]"));
  ...
  private static void registerMmoeditCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmoedit"));
    command.setPermission(
        "mcmmo.commands.mmoedit;mcmmo.commands.mmoedit.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.3", "mmoedit",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]",
        "<" + LocaleLoader.getString("Commands.Usage.Skill") + ">",
        "<" + LocaleLoader.getString("Commands.Usage.Level") + ">"));
  ...
  private static void registerSkillresetCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.skillreset"));
    command.setPermission(
        "mcmmo.commands.skillreset;mcmmo.commands.skillreset.others"); // Only
                                                                       // need
                                                                       // the
                                                                       // main
                                                                       // ones,
  ...
  private static void registerMccooldownCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mccooldown"));
  ...
  private static void registerMcabilityCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcability"));
    command.setPermission(
        "mcmmo.commands.mcability;mcmmo.commands.mcability.others");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mcability",
        "[" + LocaleLoader.getString("Commands.Usage.Player") + "]"));
  ...
  private static void registerMcmmoCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcmmo"));
    command.setPermission(
        "mcmmo.commands.mcmmo.description;mcmmo.commands.mcmmo.help");
    command.setPermissionMessage(permissionsMessage);
  ...
  private static void registerMcstatsCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcstats"));
  ...
  private static void registerMctopCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mctop"));
    command.setPermission(
        "mcmmo.commands.mctop"); // Only need the main one, not the individual
                                 // skill ones
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.2", "mctop",
        "[" + LocaleLoader.getString("Commands.Usage.Skill") + "]",
        "[" + LocaleLoader.getString("Commands.Usage.Page") + "]"));
  ...
  private static void registerMcpurgeCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcpurge",
                               Config.getInstance().getOldUsersCutoff()));
  ...
  private static void registerMcremoveCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcremove"));
    command.setPermission("mcmmo.commands.mcremove");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "mcremove",
        "<" + LocaleLoader.getString("Commands.Usage.Player") + ">"));
  ...
  private static void registerMmoshowdbCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmoshowdb"));
  ...
  private static void registerMcconvertCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcconvert"));
    command.setPermission(
        "mcmmo.commands.mcconvert;mcmmo.commands.mcconvert.experience;mcmmo.commands.mcconvert.database");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString("Commands.Usage.2", "mcconvert",
  ...
  private static void registerAdminChatCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.adminchat"));
    ...
    command.setUsage(
        command.getUsage() + "\n" +
        LocaleLoader.getString(
            "Commands.Usage.1", "adminchat",
            "<" + LocaleLoader.getString("Commands.Usage.Message") + ">"));
  ...
  private static void registerPartyChatCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.partychat"));
  ...
  private static void registerPartyCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.party"));
    command.setPermission(
  ...
  private static void registerPtpCommand() {
    ...
    command.setPermission(
        "mcmmo.commands.ptp"); // Only need the main one, not the individual
                               // ones for toggle/accept/acceptall
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString(
        "Commands.Usage.1", "ptp",
        "<" + LocaleLoader.getString("Commands.Usage.Player") + ">"));
    command.setUsage(command.getUsage() + "\n" +
  ...
  private static void registerHardcoreCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.hardcore"));
    command.setPermission(
        "mcmmo.commands.hardcore;mcmmo.commands.hardcore.toggle;mcmmo.commands.hardcore.modify");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(
        LocaleLoader.getString("Commands.Usage.1", "hardcore", "[on|off]"));
    command.setUsage(
        command.getUsage() + "\n" +
        LocaleLoader.getString(
            "Commands.Usage.1", "hardcore",
            "<" + LocaleLoader.getString("Commands.Usage.Rate") + ">"));
  ...
  private static void registerVampirismCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.vampirism"));
    command.setPermission(
        "mcmmo.commands.vampirism;mcmmo.commands.vampirism.toggle;mcmmo.commands.vampirism.modify");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(
        LocaleLoader.getString("Commands.Usage.1", "vampirism", "[on|off]"));
    command.setUsage(
        command.getUsage() + "\n" +
        LocaleLoader.getString(
            "Commands.Usage.1", "vampirism",
            "<" + LocaleLoader.getString("Commands.Usage.Rate") + ">"));
  ...
  private static void registerMcnotifyCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mcnotify"));
  ...
  private static void registerMHDCommand() {
    ...
    command.setDescription(
        "Resets all mob health bar settings for all players to the default"); // TODO: Localize
  ...
  private static void registerMcscoreboardCommand() {
    ...
    command.setDescription(
        "Change the current mcMMO scoreboard being displayed"); // TODO:
                                                                // Localize
    command.setPermission("mcmmo.commands.mcscoreboard");
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(LocaleLoader.getString("Commands.Usage.1", "mcscoreboard",
                                            "<CLEAR | KEEP>"));
    command.setUsage(command.getUsage() + "\n" +
  ...
  private static void registerReloadLocaleCommand() {
    ...
    command.setPermissionMessage(permissionsMessage);
    command.setUsage(
        LocaleLoader.formatString("Commands.Usage.0", "mcmmoreloadlocale"));
  ...
  private static void registerCompatibilityCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmocompat"));
    command.setUsage(
        LocaleLoader.formatString("Commands.Usage.0", "mmocompat"));
  ...
  private static void registerXPBarCommand() {
    ...
    command.setDescription(
        LocaleLoader.getString("Commands.Description.mmoxpbar"));
    command.setUsage(LocaleLoader.formatString("Commands.Usage.1", "mmoxpbar",
                                               "<skillname | reset>",
                                               "<show | hide>"));
