...
public class MaterialMapStore {
  ...
  private void fillBows() { bows.add("bow"); }
  ...
  private void fillTridents() { tridents.add("trident"); }
  ...
  public boolean isStringTool(String id) { return stringTools.contains(id); }
  ...
  private void fillToolBlackList() {
    ...
    // TODO: Reorganize this list, can we also dynamically populate some of
    // this?
