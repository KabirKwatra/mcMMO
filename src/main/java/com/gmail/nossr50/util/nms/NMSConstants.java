...
public class NMSConstants {
  ...
  public final static String CRAFT_BUKKIT_PACKAGE_PATH =
  ...
  getFullyQualifiedCraftBukkitPath(String cbVersionPackage,
                                   String targetClass) {
    return CRAFT_BUKKIT_PACKAGE_PATH + "." + cbVersionPackage + "." +
        targetClass;
  }
  ...
  public static String getCraftPlayerClassPath(String cbVersionPackage) {
    return getFullyQualifiedCraftBukkitPath(cbVersionPackage,
                                            CRAFT_PLAYER_CLASS_PATH);
  }
  ...
  String getCraftBukkitVersionPath(NMSVersion nmsVersion) {
    switch (nmsVersion) {
