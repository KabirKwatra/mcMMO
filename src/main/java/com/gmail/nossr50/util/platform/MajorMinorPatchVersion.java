...
public abstract class MajorMinorPatchVersion implements Versioned {
  ...
  @NotNull private final SimpleNumericVersion majorVersion;
  @NotNull private final SimpleNumericVersion minorVersion;
  @NotNull private final SimpleNumericVersion patchVersion;
   ...
   * @return patch version string or null if patch numeric value is less than or
   *     equal to 0
   */
  ...
  public String getVersionStr() {
    if (isPatch()) {
      return majorVersion.getVersionString() + "." + minorVersion + "." +
          patchVersion;
    } else {
   ...
   */
  public boolean isPatch() { return patchVersion.asInt() > 0; }
