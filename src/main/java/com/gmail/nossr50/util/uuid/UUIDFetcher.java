...
public class UUIDFetcher implements Callable<Map<String, UUID>> {
  ...
  public UUIDFetcher(List<String> names) { this(names, true); }
  ...
  public Map<String, UUID> call() throws Exception {
    ...
    for (int i = 0; i < requests; i++) {
      ...
      List<String> nameSubList =
          names.subList(i * PROFILES_PER_REQUEST,
      ...
      InputStreamReader tempStream =
          new InputStreamReader(connection.getInputStream());
      JsonObject[] jsonStreamArray =
          gson.fromJson(tempStream, JsonObject[].class);
      tempStream.close();
